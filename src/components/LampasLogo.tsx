  ...
  return (
    <div style={{ display: 'inline-flex', alignItems: 'center', gap }}>
      <svg width={sw} height={height} viewBox="0 0 24 48" fill="none">
        ...
        <path d="M12 10 C14 15 15 22 13 28 C12.5 31 12 32 12 32 C12 32 11.5 31 11 28 C9 22 10 15 12 10 Z" fill="#f2d06a" opacity="0.6"/>
...
export function LampasMarkIcon({ size = 36 }: MarkProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none">
      ...
      <path d="M18 8 C20 11 21 16 20 20 C19.5 22 18 23 18 23 C18 23 16.5 22 16 20 C15 16 16 11 18 8 Z" fill="#f2d06a" opacity="0.6"/>
