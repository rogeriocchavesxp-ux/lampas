...
const ESTUDO_DOUTRINARIO: StudyModeConfig = {
  ...
  tagline: 'Investigação da fé que busca compreender',
  color: '#1E40AF',
  ...
  topicLabel: 'Doutrina',
  defaultSection: 'doutr_conceito',
  defaultExpandedPhases: ['preparar'],
  defaultExpandedCanons: ['doutr_fundamentar_mode'],
  defaultExpandedGroups: ['doutr_conceito_grp'],
  phases: [
    {
      id: 'preparar', roman: 'I', label: 'Fundamentação',
      description: 'O que a Bíblia ensina sobre esta doutrina',
      color: '#1E40AF', bgActive: 'rgba(30,64,175,0.08)',
      modes: [{
        id: 'doutr_fundamentar_mode', label: 'Fundamento Bíblico', subtitle: 'Conceito, texto e história redentiva',
        color: '#1E40AF', bgActive: 'rgba(30,64,175,0.08)',
        groups: [
          { id: 'doutr_conceito_grp',          label: 'Conceito' },
          { id: 'doutr_fundbiblica_grp',        label: 'Fundamentação Bíblica' },
          { id: 'doutr_desenvolvredentivo_grp', label: 'Desenvolvimento Redentivo' },
        ],
      }],
    },
    {
      id: 'investigar', roman: 'II', label: 'Sistematização',
      description: 'Como a Igreja compreendeu e organizou esse ensino',
      color: '#163A6B', bgActive: 'rgba(30,77,140,0.08)',
      modes: [{
        id: 'doutr_sistematizar_mode', label: 'Teologia Sistemática', subtitle: 'Relações, história, controvérsias e síntese',
        color: '#163A6B', bgActive: 'rgba(30,77,140,0.08)',
        groups: [
          { id: 'doutr_relacoes_grp',      label: 'Relações Doutrinárias' },
          { id: 'doutr_historia_grp',      label: 'História da Doutrina' },
          { id: 'doutr_controversias_grp', label: 'Controvérsias e Erros' },
          { id: 'doutr_sintese_grp',       label: 'Síntese Doutrinária' },
        ],
      }],
    },
    {
      id: 'comunicar', roman: 'III', label: 'Implicações',
      description: 'O que essa doutrina muda na vida, na Igreja e no ministério',
      color: '#7C3AED', bgActive: 'rgba(124,58,237,0.08)',
      modes: [{
        id: 'doutr_implicacoes_mode', label: 'Aplicação Doutrinária', subtitle: 'Teologia, Igreja, pastoral e missão',
        color: '#7C3AED', bgActive: 'rgba(124,58,237,0.08)',
        groups: [
          { id: 'doutr_implicacoes_grp', label: 'Implicações' },
        ],
      }],
    },
    toolPhase(),
...
const ESTUDO_TEMATICO: StudyModeConfig = {
  ...
  defaultExpandedCanons: ['et_definir_mode', 'et_investigar_mode'],
  ...
  phases: [
    ...
    {
      id: 'investigar', roman: 'II', label: 'Investigar',
      description: 'Ocorrências, desenvolvimento canônico e teologia bíblica do tema',
      color: 'var(--accent)', bgActive: 'rgba(30,77,140,0.08)',
      modes: [{
        ...
        groups: [
          ...
          { id: 'et_relacao_cristo_grp',     label: 'Relação com Cristo' },
          { id: 'et_implicacoes_grp',        label: 'Implicações Teológicas' },
    ...
    {
      id: 'comunicar', roman: 'III', label: 'Produzir',
      description: 'Teologia sistemática e produções a partir do tema',
      color: 'var(--ai)', bgActive: 'rgba(139,92,246,0.08)',
      modes: [{
...
const ESTUDO_TERMOS: StudyModeConfig = {
  ...
  passageLabel: 'Texto âncora',
  topicLabel: 'Termo',
  defaultSection: 'termos_definicao',
  defaultExpandedPhases: ['preparar'],
  defaultExpandedCanons: ['termos_definir_mode'],
  defaultExpandedGroups: ['termos_definicao_grp'],
  phases: [
    {
      id: 'preparar', roman: 'I', label: 'Definir',
      description: 'Os 5 tópicos clássicos — compreender o termo',
      color: '#0D9488', bgActive: 'rgba(13,148,136,0.08)',
      modes: [{
        id: 'termos_definir_mode', label: 'Análise Conceitual', subtitle: 'Definição, comparação e relações',
        color: '#0D9488', bgActive: 'rgba(13,148,136,0.08)',
        groups: [
          { id: 'termos_definicao_grp',    label: 'Definição' },
          { id: 'termos_comparacao_grp',   label: 'Comparação' },
          { id: 'termos_relacao_grp',      label: 'Relação' },
          { id: 'termos_circunstancia_grp', label: 'Circunstância' },
          { id: 'termos_testemunho_grp',   label: 'Testemunho' },
          { id: 'termos_sint_inicial_grp', label: 'Síntese Inicial' },
        ],
      }],
    },
    {
      id: 'investigar', roman: 'II', label: 'Investigar',
      description: 'Rastreio bíblico e teológico do termo nas Escrituras',
      color: '#163A6B', bgActive: 'rgba(30,77,140,0.08)',
      modes: [{
        id: 'termos_investigar_mode', label: 'Investigação Bíblica', subtitle: 'Uso e distribuição canônica',
        color: '#163A6B', bgActive: 'rgba(30,77,140,0.08)',
        groups: [
          { id: 'termos_uso_biblico_grp',  label: 'Uso Bíblico' },
          { id: 'termos_canonico_grp',     label: 'Desenvolvimento Canônico' },
          { id: 'termos_uso_pericope_grp', label: 'Uso no Livro / Perícope' },
          { id: 'termos_campo_sem_grp',    label: 'Campo Semântico' },
          { id: 'termos_rel_teol_grp',     label: 'Relações Teológicas' },
          { id: 'termos_conceitos_grp',    label: 'Conceitos Associados' },
          { id: 'termos_sint_invest_grp',  label: 'Síntese Investigativa' },
        ],
      }],
    },
    {
      id: 'comunicar', roman: 'III', label: 'Produzir',
      description: 'Consolidação e comunicação do estudo do termo',
      color: '#7C3AED', bgActive: 'rgba(124,58,237,0.08)',
      modes: [{
        id: 'termos_produzir_mode', label: 'Produção Lexical', subtitle: 'Definição final e implicações',
        color: '#7C3AED', bgActive: 'rgba(124,58,237,0.08)',
        groups: [
          { id: 'termos_sintese_def_grp',   label: 'Definição Final' },
          { id: 'termos_aplicacoes_grp',    label: 'Aplicações' },
          { id: 'termos_sint_final_grp',    label: 'Síntese Final' },
        ],
      }],
    },
    toolPhase(),
...
const ESTUDO_NARRATIVAS: StudyModeConfig = {
  ...
  topicLabel: 'Tema',
  defaultSection: 'nr_preparar_visao_geral',
  defaultExpandedPhases: ['preparar', 'investigar'],
  ...
  phases: [
    ...
    {
      id: 'investigar', roman: 'II', label: 'Investigar',
      description: 'Exegese narrativa em contexto, texto e teologia',
