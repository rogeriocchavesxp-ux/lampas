...
const ESTUDO_TERMOS: StudyModeConfig = {
  ...
  defaultExpandedPhases: ['preparar', 'investigar'],
  defaultExpandedCanons: ['termos_definir_mode', 'termos_investigar_mode'],
  ...
  phases: [
    ...
    {
      id: 'investigar', roman: 'II', label: 'Investigar',
      description: 'Léxico, ocorrências, uso bíblico e desenvolvimento canônico',
      ...
      modes: [{
        ...
        groups: [
          ...
          { id: 'termos_uso_at_grp',            label: 'Uso no AT' },
          { id: 'termos_uso_nt_grp',            label: 'Uso no NT' },
          { id: 'termos_desenv_canonico_grp',   label: 'Desenvolvimento Canônico' },
          { id: 'termos_relacao_cristo_grp',    label: 'Relação com Cristo' },
          { id: 'termos_implicacoes_grp',       label: 'Implicações Teológicas' },
        ],
      }],
    },
    {
      id: 'comunicar', roman: 'III', label: 'Produzir',
      description: 'Síntese teológica e produções a partir do termo',
      color: '#7C3AED', bgActive: 'rgba(124,58,237,0.08)',
      modes: [{
