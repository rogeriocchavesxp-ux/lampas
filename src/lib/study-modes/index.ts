...
const ESTUDO_TERMOS: StudyModeConfig = {
  ...
  phases: [
    {
      id: 'preparar', roman: 'I', label: 'Definir',
      description: 'Significado, campo semântico e distinções do termo',
      color: '#0D9488', bgActive: 'rgba(13,148,136,0.08)',
      modes: [{
        id: 'termos_definir_mode', label: 'Análise Conceitual', subtitle: 'Definição e comparação',
        color: '#0D9488', bgActive: 'rgba(13,148,136,0.08)',
        groups: [
    ...
    {
      id: 'investigar', roman: 'II', label: 'Investigar',
      description: 'Relações teológicas, contexto histórico e testemunho bíblico',
      color: '#163A6B', bgActive: 'rgba(30,77,140,0.08)',
      modes: [{
        id: 'termos_investigar_mode', label: 'Investigação Bíblica', subtitle: 'Relação, circunstância e testemunho',
        color: '#163A6B', bgActive: 'rgba(30,77,140,0.08)',
        groups: [
    ...
    {
      id: 'comunicar', roman: 'III', label: 'Produzir',
      description: 'Síntese consolidada e produção a partir do termo',
      color: '#7C3AED', bgActive: 'rgba(124,58,237,0.08)',
      modes: [{
        id: 'termos_sintese_mode', label: 'Síntese e Produção', subtitle: 'Definição final e implicações',
        color: '#7C3AED', bgActive: 'rgba(124,58,237,0.08)',
        groups: [
          { id: 'termos_sintese_def_grp', label: 'Síntese' },
        ],
      }],
    },
    toolPhase(),
