...
const HELP_SEEDS: HelpSeed[] = [
  ...
  { id: 'nr_intertext_prefiguracao', titulo: 'Prefiguração', categoria: 'teologico', foco: 'eventos, personagens ou padrões desta narrativa que antecipam algo posterior — ou que realizam algo prefigurado anteriormente na Escritura', exemplo: 'Em Êxodo 2.17-19, Moisés defende as filhas de Reuel contra pastores — uma cena aparentemente secundária que prefigura o papel de libertador que Deus tem para ele diante de Israel oprimido.' },
  { id: 'nr_intertext_alusao', titulo: 'Alusão', categoria: 'teologico', foco: 'referências literárias conscientes do narrador a narrativas anteriores — por meio de paralelos verbais, estruturais ou situacionais', exemplo: 'Em Juízes 19, quando os homens de Gibeá cercam a casa e exigem o hóspede, o narrador evoca deliberadamente Gênesis 19 (Sodoma): os paralelos verbais são precisos e a intenção é mostrar que Israel caiu ao nível de Sodoma.' },
  { id: 'nr_intertext_contraste', titulo: 'Contraste Narrativo', categoria: 'teologico', foco: 'personagens ou episódios em outras narrativas bíblicas que o autor coloca intencionalmente em contraste com esta história', exemplo: 'Em 1 Samuel, as mães de Sansão e de Mica funcionam como contrastes deliberados de Ana: o filho nazireu de Ana (Samuel) cumpre o papel que o de Sansão deveria ter cumprido, e a devoção de Ana contrasta com a obsessão idolátrica da mãe de Mica.' },
  { id: 'nr_intertext_eco', titulo: 'Eco', categoria: 'teologico', foco: 'repetição de ações ou declarações de uma narrativa anterior que ratificam, aprofundam ou completam um compromisso anterior', exemplo: 'Quando Jacó retorna a Betei em Gênesis 35 e Deus reitera a aliança, os atos de Jacó ecoam ponto a ponto Gênesis 28 — a repetição não é redundância, mas ratificação solene: a jornada espiritual de Jacó está completa.' },
