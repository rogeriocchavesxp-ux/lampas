  ...
  // ── INVESTIGAR: SEÇÕES COMBINADAS ────────────────────────────────────────
  {
    ...
    cards: [
      ...
      },
      {
        ...
        placeholder: 'Identifique o gênero literário, o propósito do autor e a função desta passagem dentro do livro.',
      ...
      {
        id: 'contexto_canonico',
        title: 'Contexto canônico',
        placeholder: 'Explique como esta passagem se relaciona com o restante das Escrituras e com o desenvolvimento da revelação bíblica.',
    ...
    cards: [
      {
        ...
        placeholder: 'Registre observações relevantes do hebraico ou grego que ajudem a compreender o texto.',
      ...
      {
        id: 'estrutura_do_texto',
        title: 'Estrutura do texto',
        placeholder: 'Descreva como a passagem está organizada: unidades, movimentos, contrastes, paralelos e progressão.',
      ...
      {
        id: 'observacoes_exegeticas',
        title: 'Observações exegéticas',
        placeholder: 'Anote detalhes gramaticais, lexicais, sintáticos e literários importantes para a interpretação.',
      ...
      {
        id: 'mensagem_primeiros_ouvintes',
        title: 'Mensagem aos primeiros ouvintes',
        placeholder: 'Explique como os primeiros leitores ou ouvintes teriam compreendido esta passagem em seu contexto original.',
    ...
    cards: [
      {
        ...
        placeholder: 'Mostre como esta passagem se encaixa no desenvolvimento do plano redentivo de Deus.',
      ...
      },
      {
        id: 'doutrinas',
        title: 'Doutrinas',
        placeholder: 'Identifique as doutrinas ensinadas, pressupostas ou iluminadas por esta passagem.',
      ...
      },
      {
        id: 'implicacoes',
        title: 'Implicações',
        placeholder: 'Registre implicações teológicas, pastorais e práticas derivadas do texto.',
